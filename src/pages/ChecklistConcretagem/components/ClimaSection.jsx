          ...
          {periodos.map((periodo, index) => (
            <Card key={index}>
              <CardHeader className="pb-3">
                <CardTitle className="text-base capitalize">{PERIODO_LABEL[periodo.periodo] || periodo.periodo}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                ...
                <div>
                  ...
                  <Select value={periodo.condicoes_climaticas} onValueChange={(v) => update(index, { condicoes_climaticas: v })}>
