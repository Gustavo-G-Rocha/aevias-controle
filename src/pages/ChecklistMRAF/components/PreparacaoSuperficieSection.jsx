...
export default function PreparacaoSuperficieSection({ data, onChange, isEditable, isApproved }) {
  ...
  const BoolRow = ({ field, label, children }) => (
    <tr>
      <td className="border border-slate-300 px-4 py-3 text-slate-700">{children || label}</td>
  ...
  return (
    <div>
      <h3 className="text-lg font-semibold text-slate-700 mb-4">Acompanhamento da Condição e Preparação da Superfície</h3>
      <table className="w-full border-collapse border border-slate-300 text-base">
        ...
        <tbody>
          ...
          <tr>
            <td className="border border-slate-300 px-4 py-3 text-slate-700">Temperatura do pavimento:</td>
