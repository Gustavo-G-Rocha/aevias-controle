...
const fields = [
  ...
  { key: 'umidade',             label: 'Umidade (%)',                           required: false, readOnly: true,  className: 'bg-slate-100' },
  ...
  { key: 'peso_ligante',        label: 'Peso do Ligante (g)',                   required: false, readOnly: true,  className: 'bg-slate-100' },
  { key: 'teor_ligante',        label: 'Teor de Ligante (%)',                   required: false, readOnly: true,  className: 'bg-slate-100' },
  { key: 'residuo_emulsao',     label: 'Resíduo da Emulsão (%)',                required: false, readOnly: false },
  { key: 'percentual_emulsao',  label: '% de Emulsão',                          required: false, readOnly: true,  className: 'bg-green-50 font-semibold' },
];
