  ...
  return (
    <div className="bg-white font-sans">
      ...
      {!temMultiplasCargas && cargas.length === 1 && (
        <div className="print-page w-full max-w-[210mm] mx-auto bg-white min-h-[297mm] p-8">
      ...
      {temMultiplasCargas && cargas.map((carga, idx) => (
        <div key={idx} className="print-page w-full max-w-[210mm] mx-auto bg-white min-h-[297mm] p-8">
          <ConcretagemPageHeader regional={regional} data={checklist.data} titulo={"CONTROLE TECNOLÓGICO\nDE CONCRETO"} />
          {idx === 0 && <DadosClimaObs />}
          <div className="mb-2">
