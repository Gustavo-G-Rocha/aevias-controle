...
/**
 * Páginas de Relatório Fotográfico do Controle de Execução de Serviços.
 * 6 fotos por folha (grade 3x2), no mesmo padrão do Checklist de Terraplanagem.
 */
export default function ControleExecucaoServicosFotoPages({ data }) {
    ...
    <>
      {photoChunks.map((pageChunk, pageIndex) => (
        <div key={`page-${pageIndex}`} className="print:pt-2 print:pb-3 break-before-page">
          <div className="w-full max-w-[210mm] mx-auto bg-white pt-2 px-3 pb-3 print:pt-2 print:px-3 print:pb-3 flex flex-col">
            {/* Cabeçalho */}
            <header className="grid grid-cols-3 items-center border-b-2 border-slate-900 pb-1 mb-2">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-600">Controle de Execução de Serviços</p>
