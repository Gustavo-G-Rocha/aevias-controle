    ...
    <div className="bg-white font-sans">
      <style>{`
        ...
        @media print {
          ...
          /* Sem break-after nem min-height: ambos geravam folhas em branco.
             A quebra entre conteúdo e fotos é feita pelo break-before-page
             no wrapper das páginas de fotos. */
          .rfc-main {
            padding: 0 !important;
