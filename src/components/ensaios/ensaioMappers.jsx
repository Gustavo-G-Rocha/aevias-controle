...
const ENSAIO_CONFIG = {
  ...
  RegistroFresagemCBUQ:         { name: "Registro de Fresagem e CBUQ", label: 'Fresagem e CBUQ', icon: ClipboardList, dateField: "data", reportPage: "RelatorioFresagemCBUQ", color: '#C2410C', description: 'Novo registro de fresagem e lançamento de CBUQ', localInfo: campoLocalInfo },
