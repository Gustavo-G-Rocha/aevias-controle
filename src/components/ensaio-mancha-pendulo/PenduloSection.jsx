          ...
          <table className="w-full border-collapse border border-border text-xs">
            <thead className="bg-muted">
              <tr>
                ...
                <th className="border border-border p-2">Estaca</th>
                <th className="border border-border p-2">Faixa/Pista</th>
                <th className="border border-border p-2">Bordo</th>
                <th className="border border-border p-2">Temp. Pavimento (°C)</th>
                <th className="border border-border p-2">1º</th>
                <th className="border border-border p-2">2º</th>
                <th className="border border-border p-2">3º</th>
                <th className="border border-border p-2">4º</th>
                <th className="border border-border p-2">5º</th>
                <th className="border border-border p-2">Máxima</th>
                <th className="border border-border p-2">Mínima</th>
                <th className="border border-border p-2">VRD</th>
                <th className="border border-border p-2">Classe</th>
              </tr>
            </thead>
            <tbody>
