          ...
          <table className="w-full border-collapse border border-border text-xs">
            <thead className="bg-muted">
              <tr>
                ...
                <th className="border border-border p-2">D1 (Ø) mm</th>
                <th className="border border-border p-2">D2 (Ø) mm</th>
                <th className="border border-border p-2">D3 (Ø) mm</th>
                <th className="border border-border p-2">D4 (Ø) mm</th>
                <th className="border border-border p-2">D(Ø) Média mm</th>
                <th className="border border-border p-2">Área cm²</th>
                <th className="border border-border p-2">HS cm</th>
                <th className="border border-border p-2">HS mm</th>
                <th className="border border-border p-2">Tipo Superfície</th>
              </tr>
            </thead>
            <tbody>
